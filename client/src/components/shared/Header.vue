  ...
  <header class="header">
    <div class="wrapper-nav">
      ...
      <div v-if="isMobile" class="burger" @click="isMenuOpen = true">
        <img
          src="../../../public/assets/images/shared/icon-hamburger.svg"
          alt="icon-hamburger"
        />
      </div>
      ...
      <nav v-if="!isMobile || isMenuOpen" class="nav">
        ...
        >
          <img
            src="../../../public/assets/images/shared/icon-close.svg"
            alt="icon-close"
          />
        </div>
        ...
        <ul>
          <li v-for="(link, i) in links" :key="link.name">
            <router-link
              ...
              :class="{
                'active-nav': $route.path
                  .toLowerCase()
                  .includes(link.name.toLowerCase()),
              }"
              @click="activeLink = link.name"
            >
              <span class="number">{{ formatIndex(i) }}</span
