...
function getImagesForPage(pageName) {
  ...
  return {
    mobile: new URL(
      `../public/assets/images/${lower}/background-${lower}-mobile.jpg`,
      import.meta.url,
    ).href,
    tablet: new URL(
      `../public/assets/images/${lower}/background-${lower}-tablet.jpg`,
      import.meta.url,
    ).href,
    desktop: new URL(
      `../public/assets/images/${lower}/background-${lower}-desktop.jpg`,
      import.meta.url,
    ).href,
  };
}
